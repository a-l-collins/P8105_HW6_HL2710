...
```
    ...
    ##          <int>         <dbl> <dbl>    <dbl>      <dbl>
    ## 1            1          7.81  1.02 -0.00539      -189.
    ## 2            2          7.84  1.01 -0.00512      -198.
    ## 3            3          7.88  1.01 -0.00650      -155.
    ## 4            4          7.73  1.02 -0.00495      -206.
    ## 5            5          7.70  1.02 -0.00613      -166.
    ## 6            6          7.77  1.01 -0.00778      -130.
...
```
    ...
    ## 1            1     0.941         0.941  2.75    17186.       0     2 -5286.
    ## 2            2     0.940         0.940  2.76    17047.       0     2 -5286.
    ## 3            3     0.936         0.936  2.82    15863.       0     2 -5329.
    ## 4            4     0.939         0.939  2.77    16754.       0     2 -5275.
    ## 5            5     0.943         0.943  2.67    17839.       0     2 -5209.
    ## 6            6     0.947         0.947  2.59    19435.       0     2 -5154.
...
```
    ...
    ## 1            1  -188.5854 0.9405637
    ## 2            2  -198.0913 0.9401606
    ## 3            3  -155.3255 0.9360902
    ## 4            4  -206.4855 0.9393626
    ## 5            5  -166.2065 0.9427402
    ## 6            6  -130.3887 0.9471244
...
Testing model fit using residuals:
...
![](P8105_HW6_HL2710_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](P8105_HW6_HL2710_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

This model standing alone looks like a good fit for the data; when
comparing the residuals against the birth weight variable, the residuals
follow a very linear path with few outliers, and when compared against
predicted values, the shape of the residuals plot is generally
