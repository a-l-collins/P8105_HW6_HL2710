...
```
    ...
    ##          <int>         <dbl> <dbl>    <dbl>      <dbl>
    ## 1            1          7.72  1.03 -0.00723      -142.
    ## 2            2          7.75  1.02 -0.00488      -209.
    ## 3            3          7.86  1.01 -0.00598      -170.
    ## 4            4          7.64  1.02 -0.00504      -202.
    ## 5            5          7.77  1.02 -0.00628      -162.
    ## 6            6          7.66  1.03 -0.00546      -188.
...
```
    ...
    ## 1            1     0.944         0.944  2.66    18109.       0     2 -5179.
    ## 2            2     0.940         0.940  2.70    16960.       0     2 -5246.
    ## 3            3     0.944         0.944  2.66    18331.       0     2 -5206.
    ## 4            4     0.942         0.942  2.69    17637.       0     2 -5230.
    ## 5            5     0.942         0.942  2.69    17699.       0     2 -5219.
    ## 6            6     0.943         0.942  2.75    17848.       0     2 -5293.
...
```
    ...
    ## 1            1  -141.8522 0.9437668
    ## 2            2  -208.6772 0.9398465
    ## 3            3  -169.7142 0.9441420
    ## 4            4  -202.4609 0.9420708
    ## 5            5  -161.8659 0.9423628
    ## 6            6  -188.4066 0.9425445
...
precipitation $\hat{\beta}_ {2}$ decreases, the $\hat{r}^{2}$ value
tends to increase.
